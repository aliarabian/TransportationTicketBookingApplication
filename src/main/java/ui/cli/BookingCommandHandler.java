...
import com.transportation.airline.tickets.booking.boundry.BookingService;
import com.transportation.airline.tickets.booking.boundry.PlaneTicketBookingService;
...
import com.transportation.airline.tickets.booking.entity.SeatingSection;
import com.transportation.search.boundary.AirlineTransportationsResource;
...
public class BookingCommandHandler implements CommandHandler {
    ...
    public BookingCommandHandler() {
        ...
        bookingService = new PlaneTicketBookingService(new InMemoryAirlineTransportationDaoImpl(), new CustomerDaoImpl(), new PassengerMapperImpl());
    }
